...
def tracking_objects(Seg_Tracker, input_video):
    if Seg_Tracker is None:
        # You can return None or a message, depending on your UI
        raise gr.Error("Please segment the first frame before starting tracking.")
    ...
    with app:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=0.5):
                ...
                input_video_first_frame = gr.Image(label='Segment result of first frame',interactive=True,height=550)
